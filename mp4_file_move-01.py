...
#fullname = fullnames[0]
    if fullname[-4:].lower() == ".mp4" :
        ...
        try :
            ...
            os.rename(fullname, '{0}{1}_{2:08d}_py.mp4'.format(save_dir_name, mov_datetime, Img_N))
            #print(fullname, '{0}{1}_{2:08d}_py.jpg'.format(save_dir_name, image_datetime, Img_N))
            photo_utilities.write_log(log_file, '{3}:::{0}{1}_{2:08d}_py.mp4'.format(save_dir_name, mov_datetime, Img_N, datetime.now()))
